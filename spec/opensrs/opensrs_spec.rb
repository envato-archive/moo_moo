...
=begin
    ...
    describe "can update?" do
      #use_vcr_cassette "can_update"

      it "should return true if the domain can be updated" do
        domain = random_domain
        @opensrs.register(random_domain)
        result = @opensrs.can_update?(domain)
        result.should be_true
      end
      
      it "should return false if the domain cannot be updated" do
        result = @opensrs.can_update?('example.com')
        result.should be_false
      end
    end
